                ...
                if raw_frame:
                    ...
                    if len(frame_buffer) >= 30:
                        ...
                        if op_results:
                            ...
                            # Use NATIVE resolution from actual grid
                            last_frame = frame_buffer[-1] if frame_buffer else None
                            grid_h = last_frame.h if last_frame else 1080
                            grid_w = last_frame.w if last_frame else 1920
                            forge_window = {
                                "ts_start": window_dict["window_start_epoch"],
                                "ts_end": window_dict["window_end_epoch"],
                                "grid_shape": [grid_h, grid_w],  # NATIVE resolution from frame
