...
from CompuCog_Visual_v2.gaming.truevision_schema import TelemetryWindow, OperatorResult

class EommCompositor:
    def __init__(self, config_path: str = None):
        self.config_path = config_path

    def compose_window(self, operator_results: List[OperatorResult], window_start_epoch: float,
